...
@testset verbose = true "Invalid FixedString" begin
    ...
    @test_throws ArgumentError("FixedString size N must be positive, got -1.") FixedString{-1}("123")
    @test_throws ArgumentError("FixedString size N must be positive, got 0.") FixedString{0}("")
end
